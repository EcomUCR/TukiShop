...
export default function AboutUs() {
  ...
  return (
    <div className="min-h-screen flex flex-col  ">
      ...
      {/* Hero Section */}
      <section className="relative text-center py-28 bg-gradient-to-br from-contrast-main via-contrast-secondary to-main text-white font-quicksand overflow-hidden">
        <motion.div
        ...
        >
          ...
          >
            <div className="w-40 h-1 rounded-full bg-white/50"></div>
          </motion.div>
        </motion.div>
      ...
      <section className=" py-20 px-6 md:px-16 text-center font-quicksand mx-auto max-w-[80rem]">
        <motion.p
